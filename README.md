...
| Contact email (optional) | `NEXT_PUBLIC_CONTACT_EMAIL` (Vercel env) | Shown in the contact section and footer only when set. No phone number is shown (the source site's was a US number). |
...
- `lib/site.ts` — name, description, URL, nav links.
